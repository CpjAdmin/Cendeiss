<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="Cendeisss.Error" %>
...
<body class="sign error-page-wrapper background-color background-image">
    ...
    <div class="text-container" style="padding-bottom: 30px;">
        ...
        <div class="buttons-container">
            ...
            <a class="border-button" href="mailto:fondocendeisss@coopecaja.fi.cr" target="_blank"><span class="fa fa-warning"></span>REPORTAR ERROR</a>
        </div>
    </div>
