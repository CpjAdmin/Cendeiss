<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error404.aspx.cs" Inherits="Cendeisss.error404" %>
...
<head runat="server">
    ...
    <style>
        ...
        .sign.error-page-wrapper .buttons-container {
            ...
            .sign.error-page-wrapper .buttons-container a {
                transition: text-indent .4s linear, color .5s linear, border-color .5s linear;
                font-size: 16px;
                text-transform: uppercase;
    ...
    <style>
        .background-color {
            background-color: rgba(193, 225, 239,0) !important;
        }
        ...
        .secondary-text-color {
            color: rgba(30, 68, 117, 1) !important;
        }

        .sign-text-color {
            color: rgba(235, 95, 14, 1) !important;
        }

        .sign-frame-color {
            color: rgba(30, 68, 117, 1);
        }
        ...
        .border-button {
            color: rgba(30, 68, 117, 1) !important;
            border-color: rgba(30, 68, 117, 1) !important;
        }

        .button {
            background-color: rgba(30, 68, 117, 1) !important;
...
<body class="sign error-page-wrapper background-color background-image">
    <div class="sign-container">
        ...
        <div class="pane">
            ...
            <div class="context sign-text-color">
                Hola, La página que<br />
                está buscando no existe.
            </div>
        </div>
    </div>
    <div class="text-container" style="padding-bottom: 30px;">
        ...
        <div class="context primary-text-color">
            <h4>Es posible que desee volver a la página principal.<br />
                Si piensa que algo está mal, informe de un problema.
		</h4>
        </div>
        <div class="buttons-container">
            <a class="border-button" href="https://cendeisss.coopecaja.fi.cr/"><span class="fa fa-home"></span>VOLVER</a>
            <a class="border-button" href="mailto:fondocendeisss@coopecaja.fi.cr" ><span class="fa fa-warning"></span>REPORTAR ERROR</a>
        </div>
    </div>
    ...
    <!-- Onetrust Cookies consentimiento Aviso (statuspage.io, en-GB) iniciar -->
